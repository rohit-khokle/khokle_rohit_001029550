 ...
 */
public class SysAdmin_WorkSpace extends javax.swing.JFrame {
   ...
   DB4OUtil dB4OUtil; 
    ...
    public SysAdmin_WorkSpace(JPanel userProcessContainer, UserAccount account,  EcoSystem system ,DB4OUtil dB4OUtil ) {
       ...
       this.account = account;
        ...
        userDisplayPic = this.account.getEmployee().getProfilePicture();
       ...
       // home = jPanel3;
        ...
        panelRight.add(new SysAdmin_WorkArea(this.panelRight, account, system, this.dB4OUtil));
...
//        panelRight.add(new SysAdmin_CreateEnterprise(panelRight, this.account,  this.system ));
        panelRight.add(new SysAdmin_WorkArea(this.panelRight, account, system, this.dB4OUtil));
        layout.next(panelRight);

 ...
 * @author rohit
 */
public class MyMessages_Employees extends javax.swing.JPanel {
    ...
    public MyMessages_Employees(JPanel panelRight, UserAccount userAccount, Employee employee, Organization organization, Enterprise enterprise, EcoSystem business, DB4OUtil dB4OUtil) {
    ...
    public void init(){
        // Heading
        String name = employee.getName(); // + " "+ userAccount.getfName();
    ...
    private void composeEmailKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_composeEmailKeyPressed
        ...
        panelRight.add(new SendMessages_Employees(panelRight,userAccount,employee,organization,enterprise,business,dB4OUtil));

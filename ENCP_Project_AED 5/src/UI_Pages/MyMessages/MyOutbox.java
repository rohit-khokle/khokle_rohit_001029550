 ...
 * @author rohit
 */
public class MyOutbox extends javax.swing.JPanel {
    ...
    public MyOutbox(JPanel panelRight, Patient userAccount, Organization organization, Enterprise enterprise, EcoSystem business, DB4OUtil dB4OUtil) {
    ...
    public void init(){
        // Heading
        String name = userAccount.getfName() + " "+ userAccount.getLastName();

...
import UI_Pages.InsuranceEnterprise.Claims.Claim_WorkSpace;
 ...
 * @author raunak
 */
public class ClaimsRepresentativeRole extends Role{
    ...
    public JFrame createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business,DB4OUtil dB4OUtil) {
        return new Claim_WorkSpace( userProcessContainer,  account,  organization,  enterprise,  business, dB4OUtil);
    }

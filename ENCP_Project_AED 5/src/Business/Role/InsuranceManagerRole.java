...
import UI_Pages.InsuranceEnterprise.Manager.Manager_WorkSpace;
...
public class InsuranceManagerRole extends Role{
    ...
    public JFrame createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business,DB4OUtil dB4OUtil) {
        return new Manager_WorkSpace(userProcessContainer,account,organization,enterprise,business,dB4OUtil);

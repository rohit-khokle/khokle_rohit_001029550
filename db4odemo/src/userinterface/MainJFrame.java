...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void loggedIn(boolean set){
        logoutJButton.setEnabled(set);
        loginJButton.setEnabled(!set);
        userNameJTextField.setEnabled(!set);
        passwordField.setEnabled(!set);
    }
    ...
    private void initComponents() {
        ...
        container.add(displayPanel, "card2");
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        if((ua != null)){
                ...
                container.add("workArea",(Component)ua.getRole().createWorkArea(container, ua, this.system));

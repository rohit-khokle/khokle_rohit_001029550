 ...
 * @author rohit
 */
public class ManageResManagersJPanel extends javax.swing.JPanel {
    ...
    public ManageResManagersJPanel(JPanel userProcessContainer,EcoSystem ecosystem, Restaurant res ) {
...
//        populateCustomerTable
        ...
        dtm.setRowCount(0);
            ...
            for(Employee u : ecosystem.getEmployeeDirectory().getEmployeeList()){
                Object[] row = new Object[dtm.getColumnCount()];
                    ...
                    if(u.getRole().equals("adminRole") && u.getRes().equals(this.res)){
                        row[0]=u.getName();
                        row[1]=u.getId();
                        row[2] =u.getUserName();
                        row[3] =u.getPassword();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html> <b> <font size=5>Manager for ");
        ...
        populateCustomerTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Manager ID", "Manager Name", "User Name", "Password"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        userProcessContainer.add(new CreateManager(userProcessContainer, ecosystem, res));

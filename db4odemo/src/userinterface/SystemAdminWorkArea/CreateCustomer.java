...
public class CreateCustomer extends javax.swing.JPanel {
 ...
 //   private StringBuilder warnMsg;
    ...
    public CreateCustomer(JPanel panelRight, EcoSystem admin) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("<html> <b> <font size=5>Customer Name :");

        jLabel5.setText("<html> <b> <font size=7> <u> Customer Signup");
...
//            txtPword.setText("");
        ...
        {   
                ...
                Customer cus = ecosystem.getCustomerDirectory().createCustomer(cusName, userName, pwd); //  getEmployeeDirectory().createEmployee("RRH");
                 UserAccount ua = ecosystem.getUserAccountDirectory().createUserAccount(userName, pwd, new Customer(cusName, userName, pwd), new CustomerRole());
                 JOptionPane.showMessageDialog(null, "Successfully Created Customer!");            
                 txtReset();

            
        }
        else if(this.cusName.getText() == "") JOptionPane.showMessageDialog(null, "Customer Name cannot be empty!");
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        for(Component comp: comps){
            if(comp instanceof ManageCustomersJPanel){
                ManageCustomersJPanel manageAdmin = (ManageCustomersJPanel) comp;

...
public class CreateRestaurant extends javax.swing.JPanel {
 ...
 //   private StringBuilder warnMsg;
    ...
    public CreateRestaurant(JPanel panelRight, EcoSystem admin) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html> <b> <font size=5> Capacity:");
        ...
        jLabel5.setText("<html> <b> <font size=7> <u> Add Restaurant");
...
//            txtUser.setText("");
        ...
        if(!checkCapacityPatternCorrect()){
//            txtUser.setText("");
            txtCap.setBorder(new LineBorder(Color.red));
            jLabel1.setForeground(Color.red);
            warning2.setVisible(true);
            warning2.setText("<html> Capacity can only be a value between 0-100");
        }
        else if(checkCapacityPatternCorrect()) {
            txtCap.setBorder(new LineBorder(Color.black));
            jLabel1.setForeground(Color.black);
        ...
        if(usernamePatternCorrect() && checkCapacityPatternCorrect())
        {   
                String cusName = this.resName.getText();
                Integer cap = Integer.parseInt(this.txtCap.getText());
                
                //Restaurant res = new Restaurant(cusName, cap);
                    
               if(ecosystem.getRestaurantDirectory().checkRestaurantExists(cusName))
               {
                   JOptionPane.showMessageDialog(null, "Restaurant already exists!");
               }
               else{
                 ecosystem.getRestaurantDirectory().createRestaurant(cusName,cap);
    ...
    private boolean checkCapacityPatternCorrect(){
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        for(Component comp: comps){
            if(comp instanceof ManageRestaurantsJPanel){
                ManageRestaurantsJPanel manageAdmin = (ManageRestaurantsJPanel) comp;

 ...
 */
public class CreateManager extends javax.swing.JPanel {
 ...
 //   private StringBuilder warnMsg;
    ...
    public CreateManager(JPanel panelRight, EcoSystem admin, Restaurant res) {
        initComponents();
        this.res = res;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("<html> <b> <font size=5>Manager Name :");

        jLabel5.setText("<html> <b> <font size=7> <u> Create Manager");
...
//            txtPword.setText("");
        ...
        {   
                ...
                Employee emp = ecosystem.getEmployeeDirectory().createEmployee(cusName, userName, pwd, "adminRole", res);
                UserAccount ua = ecosystem.getUserAccountDirectory().createUserAccount(userName, pwd, emp, new AdminRole());
...
//    +[A-Z]{1,}[0-9]{1,}[$*#&]{1,}
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        for(Component comp: comps){
            if(comp instanceof ManageResManagersJPanel){
                ManageResManagersJPanel manageAdmin = (ManageResManagersJPanel) comp;
